...
window.ROLE_CATALOG = [
  ...
  { id: 'patte_gauche',  label: 'Patte gauche',                    icon: 'paw',     seats: 1, max_choices: 1,
    description: 'Responsable adjoint : seconde la Tête de meute.' },
  ...
  { id: 'modo_telegram', label: 'Modérateur Telegram',             icon: 'paper-plane', seats: 2, max_choices: 2,
    description: 'Modération des groupes Telegram (2 postes).' },
  { id: 'modo_discord',  label: 'Modérateur Discord',              icon: 'headset', seats: 2, max_choices: 2,
